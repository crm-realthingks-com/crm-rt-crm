  ...
  return (
    <div 
      ...
      style={{ 
        ...
        minWidth: sidebarOpen ? '260px' : '70px',
        maxWidth: sidebarOpen ? '260px' : '70px',
        overflow: 'visible'
      }}
    >
      {/* Header */}
      <div className="flex items-center justify-center border-b border-sidebar-border relative" style={{ height: '72px' }}>
        <div 
            ...
            {menuItems.map((item) => {
              ...
              const menuButton = (
                <NavLink
                  to={item.url}
                  className={`
                    flex items-center rounded-lg relative transition-colors duration-200 font-medium w-full
                    ${active 
                ...
                >
                  <div 
                    ...
                    style={{ 
                      ...
                      minWidth: '20px',
                      minHeight: '20px',
                      marginRight: sidebarOpen ? '14px' : '0px'
                    }}
                  >
                    <item.icon 
                      className="w-5 h-5" 
      ...
      {/* Bottom Section - Pin Toggle & User & Sign Out - Fixed at Bottom */}
        ...
        <div className="flex justify-start">
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                onClick={togglePin}
                className="flex items-center justify-center rounded-lg transition-colors text-sidebar-foreground/70 hover:text-sidebar-primary hover:bg-sidebar-accent/50"
                style={{ 
                  width: '40px',
                  height: '40px',
                  marginLeft: '14px'
