          ...
          <div className="bg-muted p-3 rounded-md">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              {selectedRole === 'admin' ? (
                ...
                <>
                  <li>• Can add and edit all content</li>
                  <li>• Can access all records</li>
                  <li>• Cannot manage user roles or user accounts</li>
                  <li>• Access to settings (except user management)</li>
                </>
              ) : (
                <>
